  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{top: heightData * 16}}>
        ...
        <Text
          style={[
            FontStyle.fs16,
            FontStyle.fw600,
            {color: '#F5FF82', marginBottom: heightData * 16},
          ]}>
          [{Info.title}]
        </Text>
        <Text style={FontStyle.fs14}>게임시작: {Info.startDate}</Text>
        <Text style={[FontStyle.fs14, {paddingVertical: 3}]}>
          레지마감: {Info.regDate}
        </Text>
        <Text style={FontStyle.fs14}>바이인: {Info.bind.ticketType} {TournamentInfoBoxDemo.bind.count}장</Text>
      </View>
      ...
      <View style={{flex: 1, alignItems: 'center'}}>
        ...
        {/* 상세버튼 */}
        <View style={[styles.buttonContainer,{marginTop:heightData*24}]}>
