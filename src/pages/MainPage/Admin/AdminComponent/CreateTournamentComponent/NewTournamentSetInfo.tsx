...
const NewTournamentSetInfo = ({...props}) => {
  ...
  const onClickNextButton = () => {
    // if (!checkInputNull("Blind")) return;
    ...
    <>
      ...
      <KeyboardAwareScrollView keyboardShouldPersistTaps={'handled'} bounces={false}>
        <View
          ...
          <View style={{marginTop: widthData * 30}}>
            ...
            <TextInput
              ...
              style={[
                styles.tableSelect,
                prize ? styles.textInputOn : styles.textInputOff,
                FontStyle.fs16,
                {paddingLeft: 5},
              ]}
          ...
          <View style={{marginTop: widthData * 18}}>
            ...
            <Pressable
              onPress={() => onChangeTitle('블라인드')}
              style={[styles.blindContainer, GlobalStyles.flexCenter]}>
        ...
        <View style={{marginTop: 200 * heightData}}>
          <BottomMaxButton
            title="다음"
            backgroundColor={checkInputNull("Blind") ? '#F5FF82' : '#808080'}
            color="#000"
