        ...
        <SafeAreaView style={styles.container}>
            <View>
                <View style={HeaderStyle.headerStyle}>
                    <Text style={HeaderStyle.headerFontStyle}>선물하기</Text>
                </View>
                <IconAntDesign
                    name="left"
                    size={heightScale * 28}
                ...
                <View style={{ flex: 3.2 }} >
                    <View style={styles.container1} >
                        ...
                        <View style={styles.ticketBox} >
                            ...
                            <View style={{ flex: 3, paddingHorizontal: 13 * heightScale, justifyContent: 'center' }} >
                                <View style={{ height: 76 * heightScale }}>
                                    <Text style={styles.fontStyle3} >Black Ticket (보유 : {maxBlack})</Text>
                                    <GiftTicketCountBox ticket={black} max={maxBlack} setTicket={setBlack} />
                                </View>
                            </View>
                        ...
                        <View style={styles.ticketBox} >
                            ...
                            <View style={{ flex: 3, paddingHorizontal: 13 * heightScale, justifyContent: 'center' }} >
                                <View style={{ height: 76 * heightScale }}>
                                    <Text style={styles.fontStyle3} >Red Ticket (보유 : {maxRed})</Text>
                                    <GiftTicketCountBox ticket={red} max={maxRed} setTicket={setRed} />
                                </View>
                            </View>
                            <View style={{ flex: 1.2, alignItems: 'flex-end' }} >
                        ...
                        <View style={styles.ticketBox} >
                            ...
                            <View style={{ flex: 3, paddingHorizontal: 13 * heightScale, justifyContent: 'center' }} >
                                <View style={{ height: 76 * heightScale }}>
                                    <Text style={styles.fontStyle3} >Gold Ticket (보유 : {maxGold})</Text>
                                    <GiftTicketCountBox ticket={gold} max={maxGold} setTicket={setGold} />
                                </View>
                            </View>
                            <View style={{ flex: 1.2, alignItems: 'flex-end' }} >
            ...
            <View style={{flexDirection:'row' ,height:heightScale * 75,backgroundColor:'#3B3B3B'}}  >
                ...
                <TouchableOpacity onPress={() => setModalStatus(true)}   activeOpacity={1} style={[styles.buttonStyle, (userInfo.nickname !== "닉네임 검색") && ( blackState || redState || goldState) && styles.buttonStyle2]} >
                    <Text style={[styles.fontStyle5, (userInfo.nickname !== "닉네임 검색")  && ( blackState || redState || goldState) && styles.fontStyle7]} >선물하기</Text>
                </TouchableOpacity>
            </View>
