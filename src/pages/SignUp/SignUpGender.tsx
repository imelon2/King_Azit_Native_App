    ...
    <SafeAreaView style={SignUpstyles.container}>
      ...
      <View style={SignUpstyles.inputWrapper}>
        <View style={styles.genderBox}>
          <TouchableOpacity
            onPress={() => onClickGenderButton('male')}
            style={[
              styles.genderButton,
              gender == 'male' && styles.genderButtonOn,
            ]}>
            <Text
              style={[
                styles.genderButtonText,
                gender == 'male' && styles.genderButtonText2,
              ]}>
              남자
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => onClickGenderButton('female')}
            style={[
              styles.genderButton,
              styles.genderButton2,
              gender == 'female' && styles.genderButtonOn,
            ]}>
            <Text
              style={[
                styles.genderButtonText,
                gender == 'female' && styles.genderButtonText2,
              ]}>
              여자
            </Text>
          </TouchableOpacity>
