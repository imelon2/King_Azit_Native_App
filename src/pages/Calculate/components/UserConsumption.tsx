...
function UserConsumption() {
  ...
  const [chartData, setChartData] = useState([
    {month: 'Jan', ticket: 0, monNum: 1},
    {month: 'Feb', ticket: 0, monNum: 2},
    {month: 'Mar', ticket: 80, monNum: 3},
    {month: 'Apr', ticket: 20, monNum: 4},
    {month: 'May', ticket: 30, monNum: 5},
    {month: 'Jun', ticket: 35, monNum: 6},
    {month: 'Jul', ticket: 0, monNum: 7},
    {month: 'Aug', ticket: 0, monNum: 8},
    {month: 'Sep', ticket: 0, monNum: 9},
    {month: 'Oct', ticket: 0, monNum: 10},
    {month: 'Nov', ticket: 0, monNum: 11},
    {month: 'Dec', ticket: 0, monNum: 12},
  ]);
  ...
  return (
    <SafeAreaView style={styles.container}>
            ...
            <TouchableOpacity onPress={() => onClickLine(key)} activeOpacity={1} key={key} style={styles.viewOne}>
              {val.ticket == 0 ? (
                ...
                <View
                  style={[
                    styles.lineOne,
                    {height: val.ticket * 2 * heightScale},
                    month == key && {backgroundColor: '#FFF48D'},
                  ]}></View>
              )}
      ...
      <View style={{flex: 1.73}}>
        <TouchableOpacity
          activeOpacity={1}
          onPress={() => navigation.navigate('UserConsumptionDetail', {month: month + 1})}
          style={{flexDirection: 'row', justifyContent: 'flex-end', paddingRight: 10 * heightScale}}>
          <Text style={styles.fontStyle2}>자세히 보기</Text>
          <IconAntDesign name="right" size={heightScale * 14} color="white" style={styles.detailIcon} />
        </TouchableOpacity>
            ...
            <View key={key} style={styles.ticketBox}>
              ...
              <View style={{flex: 2.5, alignItems: 'flex-end'}}>
                <Text
                  style={[
                    styles.fontStyle2,
                    {marginTop: 6 * heightScale, fontWeight: '600', marginRight: 20 * heightScale},
                  ]}>
                  {val.data}장
                </Text>
                <Text style={[styles.fontStyle2, {marginTop: 17 * heightScale, marginRight: 20 * heightScale}]}>
                  {val.len}%
                </Text>
              </View>
            </View>
