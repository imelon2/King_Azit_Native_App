...
import TicketHistoryViewDetail from './Components/TicketHistoryViewDetail';
    ...
    <SafeAreaView style={styles.container}>
      <View>
        ...
        <View style={styles.headerStyle}>
          <Text style={styles.fontStyle}>티켓 충전 내역</Text>
        </View>
        <IconAntDesign
          name="left"
          size={heightScale * 28}
        ...
        <View style={styles.modalBox}>
          <View style={{ flex: 1 }} >
            ...
            <View style={{ flexDirection: 'row' }} >
              ...
              <TouchableOpacity activeOpacity={1} onPress={() => setSort('past')} style={[styles.slectBox, styles.slectBoxRight, sort == 'past' && styles.slectBoxOn]} >
          ...
          <View style={{ flex: 1 }} >
            <View style={{ alignItems: 'center', justifyContent: 'center' }} >
              <Text style={styles.modalText} >티켓 충전 유형</Text>
            </View>

            <View style={{ flexDirection: 'row' }} >
              <TouchableOpacity activeOpacity={1} onPress={() => setType('all')} style={[styles.slectBox, styles.slectBoxLeft, type == 'all' && styles.slectBoxOn]} >
                <Text style={[styles.slectBoxText, type == 'all' && styles.slectBoxOnText]} >전체</Text>
              </TouchableOpacity>
              <TouchableOpacity activeOpacity={1} onPress={() => setType('pay')} style={[styles.slectBox, styles.slectCenter, type == 'pay' && styles.slectBoxOn]} >
                <Text style={[styles.slectBoxText, type == 'pay' && styles.slectBoxOnText]}>결제</Text>
              </TouchableOpacity>
              <TouchableOpacity activeOpacity={1} onPress={() => setType('gift')} style={[styles.slectBox, styles.slectBoxRight, type == 'gift' && styles.slectBoxOn]} >
          ...
          <View style={{ flex: 1 }} >
            ...
            <View style={{ flexDirection: 'row' }} >
              <TouchableOpacity activeOpacity={1} onPress={() => setTicket('all')} style={[styles.slectBox, styles.slectBoxLeft, ticket == 'all' && styles.slectBoxOn]} >
...
export default AdminTicketsHistory;
